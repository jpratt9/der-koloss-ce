// Surface contact between meshes, measured on real triangles.
//
// Shared by the validators that need to know whether two parts of a model
// actually touch: validate-weapon-models.mjs (is every weapon one solid object)
// and validate-weapon-shapes.mjs (is each part fixed to what it hangs from).
...
export function pointTriSq(px, py, pz, ax, ay, az, bx, by, bz, cx, cy, cz) {
 ...
 * a face of the other.
 */
export function segHitsTri(px, py, pz, qx, qy, qz, ax, ay, az, bx, by, bz, cx, cy, cz) {
...
export function trisNear(m, region, near) {
  const out = [];
