// AudioEngine's playback: the file or render a name resolves to, the pooled voice
// it plays on, and play(), which sends each name to its layers or its fallback.
...
export class AudioEnginePlayback {
  // =====================================================================
