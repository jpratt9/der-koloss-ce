// Net's host side: opening the lobby, admitting and authenticating guests, and
// gating every packet a guest sends.
...
import { PREFIX, MAX_PLAYERS, cleanName, cleanPersona, cleanClientId } from './identity.js';
