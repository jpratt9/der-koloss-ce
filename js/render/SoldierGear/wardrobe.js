// The wardrobe: every piece of gear for one persona, built against a live
// measurement of the rig so the numbers stay honest if the spine correction
// is ever retuned.
import * as THREE from 'three';
import { HEAD_SCALE, HEAD_REF } from './constants.js';
import { put, box, tube, dome, span, strap, mergeByMaterial } from './kit.js';
 ...
 */
export function buildWardrobe(look, P) {
  const out = new Map();
  const B = look.build;
