// ZombieManager: the horde's state, damage and kills, and the frame loop that
// spawns, steps and poses every body. Its other methods are in manager-*.js.
...
import { zombiePoseForState, applyHellhoundPose } from './poses.js';
import { ZombieManagerSpawning } from './manager-spawning.js';
import { ZombieManagerMovement } from './manager-movement.js';
import { ZombieManagerAi } from './manager-ai.js';
import { ZombieManagerNet } from './manager-net.js';
