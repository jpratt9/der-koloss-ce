// The checks that fail the map build: the shell's structure, a way out of every
// room, a clear approach to every interactable, and every zone that has to stay
// clear. No DOM and no Three.js, so CI can import it.
import { MAP_ROOMS, MAP_DOOR_DEFS, MAP_WALL_RUNS } from './shell.js';
import { MAP_WALLBUYS, MAP_PERKS } from './interactables.js';
import { MAP_RAMPS, MAP_NAV_LINKS } from './traversal.js';
