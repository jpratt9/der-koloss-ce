...
import { clamp, lerp, damp, rand, choice, dist2D } from './utils.js';
...
import { GameRounds, dropId } from './game/rounds.js';
...
for (const part of [
  GameFramePacing, GameGraphics, GameBallistics, GameRounds,
]) {
